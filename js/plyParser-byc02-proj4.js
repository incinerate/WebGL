...
var fileVertexPositionBuffer;
var fileVertexNormalBuffer;
var fileVertexTextureBuffer;
var fileVertexColorBuffer;
var fileVertexIndexBuffer;
var modelData = [];
var modelScale = 40;
...
function processBuffers(recenter, rescale, randomTexture)
{
	...
	///fill the buffers                                           ///
	/////////////////////////////////////////////////////////////////
	fileVertexPositionBuffer = gl.createBuffer();
	...
	fileVertexPositionBuffer.itemSize = 3;
	fileVertexPositionBuffer.numItems = arrayVertex.length/3;

	fileVertexNormalBuffer = gl.createBuffer();
	...
	gl.bindBuffer(gl.ARRAY_BUFFER, null);
	fileVertexNormalBuffer.itemSize = 3;
	fileVertexNormalBuffer.numItems = arrayVertex.length/3;

	fileVertexTextureBuffer = gl.createBuffer();
	...
	gl.bindBuffer(gl.ARRAY_BUFFER, null);
	fileVertexTextureBuffer.itemSize = 2;
	fileVertexTextureBuffer.numItems = arrayTexture.length/2;

	fileVertexColorBuffer = gl.createBuffer();
	...
	gl.bindBuffer(gl.ARRAY_BUFFER, null);
	fileVertexColorBuffer.itemSize = 2;
	fileVertexColorBuffer.numItems = arrayTexture.length/2;
	
//	fileVertexIndexBuffer = gl.createBuffer();
//    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFERER, fileVertexIndexBuffer);
//    gl.bufferData(gl.ELEMENT_ARRAY_BUFFERER, new Uint16Array(modelData[4]), gl.STATIC_DRAW);
//    gl.bindBuffer(gl.ARRAY_BUFFER, null);
//    fileVertexIndexBuffer.itemSize = 1;
//    fileVertexIndexBuffer.numItems = arrayTexture.length;
}
